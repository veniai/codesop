...
**ready / approved**：high-risk 时页面生成 = ready，人点通过 = approved（task completed 只认 approved，同 spec-gate §8.7 B/D）；抽样命中 low 不走 approved（low 自动过），页面作 audit-log 待清审查项（§8.7 E）。
