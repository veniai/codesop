...
- **下一步**: 按需迭代
- **负责人/执行主体**: Mixed
- **最后更新原因**: v4.4.4 新项目反馈首批（CONTEXT 定位澄清 + superpowers Codex 输出注明 + 防再犯 E）
...
See [GitHub Releases](https://github.com/veniai/codesop/releases) for full version history. Current version: v4.4.4.
