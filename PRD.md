...
- **下一步**: 按需迭代
- **负责人/执行主体**: Mixed
- **最后更新原因**: v4.4.1 P1 清理（bare return ×13 + v8 命名残留 + /goal §8.7 测试覆盖缺口）
...
See [GitHub Releases](https://github.com/veniai/codesop/releases) for full version history. Current version: v4.4.1.
