...
assert_contains "$skill_full" "☑ PRD.md — 已更新"
assert_contains "$skill_full" "| P1 | 进度对齐 |"
assert_contains "$skill_full" "| P5 | 里程碑 |"
assert_contains "$skill_full" "| R1 | 安装命令 |"
assert_contains "$skill_full" "| R4 | 接口文档 |"
assert_contains "$skill_full" "| C1 | 术语变化 |"
assert_contains "$skill_full" "| A1 | 新增 ADR |"
assert_contains "$skill_full" "| A2 | 影响现有 ADR |"
...
assert_contains "$agents_template" "反膨胀"
